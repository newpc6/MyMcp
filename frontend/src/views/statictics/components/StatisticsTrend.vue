        ...
        <div class="trend-tables">
          ...
          <div class="trend-section">
            ...
            <el-table :data="trendData" stripe class="trend-table">
              <el-table-column prop="statistics_date" label="日期" width="120" />
              <el-table-column prop="total_template_groups" label="模板组" width="80" />
              <el-table-column prop="total_templates" label="模板数" width="80" />
              <el-table-column prop="total_services" label="服务数" width="80" />
            </el-table>
          </div>
          ...
          <div class="trend-section">
            ...
            <el-table :data="trendData" stripe class="trend-table">
              <el-table-column prop="statistics_date" label="日期" width="120" />
              <el-table-column prop="today_new_service_calls" label="服务调用" width="80" />
              <el-table-column prop="today_new_tools_calls" label="工具调用" width="80" />
              <el-table-column prop="today_service_calls_success" label="服务成功" width="80" />
              <el-table-column prop="today_service_calls_error" label="服务失败" width="80" />
              <el-table-column prop="today_tools_calls_success" label="工具成功" width="80" />
              <el-table-column prop="today_tools_calls_error" label="工具失败" width="80" />
            </el-table>
          </div>
        </div>
