...
.form-input :deep(.el-input__wrapper:hover) {
  border-color: #4F7BF7;
  box-shadow: 0 4px 12px rgba(79, 123, 247, 0.15);
}

.form-input :deep(.el-input__wrapper.is-focus) {
  border-color: #4F7BF7;
  box-shadow: 0 4px 12px rgba(79, 123, 247, 0.2);
}
...
.login-button {
  ...
  font-size: 16px;
  font-weight: 500;
  background: linear-gradient(135deg, #4F7BF7 0%, #5B6BCF 100%);
  border: none;
  box-shadow: 0 4px 15px rgba(79, 123, 247, 0.3);
  transition: all 0.3s ease;
}

.login-button:hover {
  transform: translateY(-2px);
  box-shadow: 0 6px 20px rgba(79, 123, 247, 0.4);
}
